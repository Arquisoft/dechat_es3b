...
///////////////////////////////////////////////////////
  ...
  await core.storeMessage(userDataUrl, "prueba", userWebId, null, "holabuenas", friendWebId, dataSync, false);
...
$('#write-chat').click(async() => {
  ...
  await core.storeMessage(userDataUrl, username, userWebId, d, message, friendWebId, dataSync, true);
...
async function processResponseInNotification(response, fileurl) {
  ...
  if (chatUrl) {
    chatUrl = chatUrl.value;
      ...
      const chatFriendWebId = await loader.findWebIdOfFriend(chatUrl, userWebId);
      const friendsName = await core.getFormattedName(chatFriendWebId);
