...
image:https://avatars3.githubusercontent.com/u/14262490?v=3&s=200["Solid", 100, 100] 
...
The skeleton project is a javascript aplication combined with solid tecnology 
application which can be run using the following command:
